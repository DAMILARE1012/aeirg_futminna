...
@section('title', '| 2020-2018 Projects')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="destination_content">
                            ...
                            <h4 class="title"><a href="javascript:void(0)" style="font-size: 16px!important;">Valorizing e-Waste in Nigeria, funded by University of Leeds, Leeds</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn">2020</a>
                            <h4 class="title"><a href="https://sabimonidemo.com/" style="font-size: 16px!important;">Development of Financial Literacy e-Learning Platform by GIZ, Nigeria</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn">2019</a>
                            <h4 class="title"><a href="https://ai4ce.com.ng/" target="_blank" style="font-size: 16px!important;">Artifical Intelligence for Clean Energy Development</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn">2019</a>
                            <h4 class="title"><a href="javascript:void(0)" style="font-size: 16px!important;">Artificial Intelligence for Pipeline Monitoring System (AI4PMS) funded by TETFUND</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.8s">
                        ...
                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn">2019</a>
                            <h4 class="title"><a href="javascript:void(0)" style="font-size: 16px!important;">Fabrication of Intelligent Wireless Mobile Phone Battery Charger, funded by (NCC)</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        <div class="destination_image">
                            <img src="{{ asset('assets/images/water_quality_system.jpeg') }}" alt="Destination">
                        </div>
                        
                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn">2018</a>
                            <h4  class="title"><a href="#" target="_blank" style="font-size: 16px!important;">Development of Artificial Intelligence Based Water Quality Monitoring and Control of Re-Circulatory Aquaculture System</a></h4>
                            <p class="price"> TETFUND - <b>N 1,229, 990.30</b></p>
                            <a class="more" href="javascript:void(0)"><i class="lni lni-chevron-right"></i></a>
                        </div>
                    </div> 
                </div>
