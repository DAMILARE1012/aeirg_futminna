            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center pb-25">
                        ...
                        <p>Enabling opportunities to help serve under us...</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination mt-30 wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        <div class="destination_image">
                            <img src="{{ asset('assets/images/ai4ce_internship_poster.jpeg') }}" alt="Destination">
                        </div>

                        <div class="destination_content">
                            <a href="javascript:void(0)" class="main-btn" style="color: red;"><b>Feb 19, 2021</b></a>
                            <h4 class="title"><a href="http://bit.ly/ai4ceinternship2021" target="_blank"
                                    rel=”noreferrer”>Call for <b>Internship</b></a></h4>
                            <p class="price">
                                <a class="price" href="http://bit.ly/ai4ceinternship2021" target="_blank"
                                    rel=”noreferrer”><b>Click here to register</b></a>
                            </p>
                            <a class="more" href="http://bit.ly/ai4ceinternship2021" target="_blank" rel=”noreferrer”><i
