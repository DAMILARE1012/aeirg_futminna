        ...
        <div class="row mt-5">
            <div class="col-lg-4">
                <div class="contact-info bg-light p-4 rounded mt-4">
                    ...
                    <p class="text-muted">For any form of request or enquiry, kindly contact us through the provided fields.</p>
                    <div class="mt-4">
                        <div class="media">
                            <i class="fa fa-address-card-o" aria-hidden="true"></i>
                            <div class="media-body pl-3">
                                <h5 class="mt-0 f-17">Head Office</h5>
                                <p class="text-muted mb-0">AI4CE Lab Federal University of Technology Minna, Niger State</p>
                            </div>
                        </div>
