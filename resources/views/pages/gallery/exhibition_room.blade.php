...
@section('title', '| Gallery - Exhibition Room')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="single_gallery mt-30">
                            <img src="{{ asset('assets/images/gallery/exhibition_room/'. $image->getFilename()) }}" alt="gallery">
                            <a class="image-popup" href="{{ asset('assets/images/gallery/exhibition_room/'. $image->getFilename()) }}" data-lightbox="mygallery" data-title="AEIRG Exhibition Room"><i class="lni lni-plus"></i></a>
                        </div> 
                    </div>
                    @endforeach
                </div>
