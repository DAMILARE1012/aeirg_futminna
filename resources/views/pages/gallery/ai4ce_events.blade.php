                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="single_gallery mt-30">
                            <img src="{{ asset('assets/images/gallery/ai4ce_events/'. $image->getFilename()) }}" alt="gallery">
                            <a class="image-popup" href="{{ asset('assets/images/gallery/ai4ce_events/'. $image->getFilename()) }}"><i class="lni lni-plus"></i></a>
                        </div> 
                    </div>
                    @endforeach
                </div>
