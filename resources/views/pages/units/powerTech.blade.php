            ...
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="about_content">
                            <div class="section_title">
                                <h3 class="title" tyle="text-align: centre!important;">About <span>Power-Tech Unit</span>
                                </h3>
                                <p style="text-align: justify;">Specialists in the development, deployment and application
                                    of technological solutions and innovations in the energy sector.
                                    We offer tech-enabled services in energy utilisation. The unit is made up of researchers
                                    and experts in designing and applying technology, thereby improving energy independence
                                    and usage efficiency. We are into tech-heavy hardware, software, and tech-enabled
                                    services for solar energy, hydro energy, wind energy, bioenergy, and geothermal energy.
                                    <br>
                                    In Power-Tech research unit, we support education through the undergraduate and
                                    graduate-level project's work to provide tech-enabled solutions to practical problems.
                                    The academia at Power-Tech research unit works with the industry to explore modern technology in power
                                    systems planning and operations, FACTS deployment, Distributed Generation, Microgrid
                                    Planning and Optimisation of renewable resources.
                                </p>
                                ...
                                <ul style="list-style-type: square; margin-left: 50px;">
                                    <li>Poised to develop local capacity in tech-enabled services in Nigeria's energy
                                        sector, leveraging industry 4.0 technologies: Artificial Intelligence, Big Data
                                        Analytics, Blockchain, Cloud Computing, Optimisation.</li>
                                ...
                                <p style="text-align: justify;">
                                    <b>Expertise</b><br>
                                    <span style="margin-left: 30px;">Energy conversion and utilisation, Demand-side
                                        management, Artificial Intelligence, IoT, Systems Automation, Robotics and
                                        Mechatronics, Blockchain, DG Planning and Optimisation, FACTS Planning and
                                        Optimisations</span> <br>
                                    <b>Applications</b> <br>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p style="margin-left: 30px"> <em>Our focus at Power-Tech research unit covers:</em>
            ...
            <div class="row mt-5 pt-2">
                <div class="col-lg-3">
                    <div class="team-box text-center py-3 rounded mt-4">
                        <div class="team-img">
                            <img src="{{ asset('assets/images/units_pix/dr_sadiq.jpeg') }}"
