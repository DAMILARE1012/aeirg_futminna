...
@section('title', '| Web & Mobile Dev. Unit')
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-6">
                            <div class="about_content">
                                <div class="section_title">
                                    <h3 class="title" tyle="text-align: centre!important;">About <span>Web & Mobile App Development Unit</span></h3>
                                    <p style="text-align: justify;">
                                        The web development unit is a member of the Advanced Engineering Innovation Research Group (AEIRG), it is specialised in developing enterprise web and mobile applications. The unit consist of experienced software developers.
                                        The unit will be involved in deploying and integration of e-learning solutions, e-commerce solutions and meet other software needs as required by clients.
                                    </p>
                                    <h5 style="text-align: centre!important; color: red; margin-top: 10px;"><span>Vision</span></h5>
                                    <p style="text-align: justify;">To become the brainstorming hub to proffer solutions to challenges faced by any organisation, institution or educational setup.</p>
                                    ...
                                    <p>
                                        <ul style="list-style-type: square; margin-left: 50px;">
                                            <li>The unit will develop world-class web and mobile applications following the bests software design principles and procedures.</li>
                                    ...
                                    <p style="text-align: justify;">
                                        <b>Expertise</b><br>
                                        <span style="margin-left: 30px;">Learning Management Systems, E-commerce Solutions, Customer Relationship Management Systems,Inventory Management Platforms,Information Management Systems
                                        </span> <br> 
                                    <b>Applications</b> <br>
                                    <span style="margin-left: 30px;">Learning Management Systems, E-commerce Solutions, Customer Relationship Management Systems,Inventory Management Platforms,Information Management Systems, E-clinic 
                                        </span> 
                                        </p>
                                </div> 
                        ...
                        <div class="col-lg-6">
                            ...
                            <h5 style="text-align: centre!important; color: red; margin-top: 10px;"><span style="margin: 20px;">Focus</span></h5>
                                    <p style="margin-left: 30px"> <em>The unit will focus on the following areas:</em>
                                        <ul style="list-style-type: square; margin-left: 50px; padding-top:5px;">
                                            ...
                                            <li>Platforms,Information Management Systems</li>
                                            <li>E-clinic</li>
