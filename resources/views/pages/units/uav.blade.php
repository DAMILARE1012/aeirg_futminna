                        ...
                        <div class="col-lg-6">
                            <div class="about_content">
                                <div class="section_title">
                                    <h3 class="title" tyle="text-align: centre!important;">About <span>Autonomous Systems & Mobility Research Unit</span></h3>
                                    <p style="text-align: justify;">Experts in design, development and usage of advanced signal processing and autonomous systems for a wide array of scientific applications
                                        <br>
                                        The Autonomous Systems and Mobility Research Unit, a member of the Advanced Engineering Innovation Research Group (AEIRG) uses off-the-shelf and custom in-house-built drones for a wide array of applications. The research unit consists of researchers who specialise on various aspects of drone design and usage which allows for design and develop of custom-made drones for specific applications. 
                                        <br>
                                        
                                        Core to our research work is the coupling of the algorithmic design and the design of the digital system in order to expose the hardware platform characteristics to the algorithm, but also to guide the hardware architecture design through the characteristics of the algorithm. 
                                        <br>
                                        The ASM Research Unit will support education by bringing real-world UAV development into undergraduate and graduate level courses. We work with academia and industry to explore potential UAV uses and opportunities, such as precision agriculture, monitoring and surveillance of critical assets as well as developing a framework for safely integrating UAVs into the national airspace.
                                        
                                        </p>
                                    <h5 style="text-align: centre!important; color: red; margin-top: 10px;"><span>Vision</span></h5>
                                    <p style="text-align: justify;">To be the go-to centre for delivering drone and ground robot solutions	 to the	country in both military and civilian applications and	across	different fields of human endeavour.</p>
                                    ...
                                    <p>
                                        <ul style="list-style-type: square; margin-left: 50px;">
                                            <li>The ASM Research Unit will educate, train and develop local competence in contemporary autonomous systems development while	leveraging on advanced signal processing techniques through the synthesis, analysis, experimentation, and design of unmanned systems for  proffering practical solutions to	day-to-day problems	and  achieving industry 4.0 in Nigeria.</li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <h5 style="text-align: centre!important; color: red; margin-top: 10px;"><span style="margin: 20px;">Focus</span></h5>
                                    <p style="margin-left: 30px"> <em>The ASM Research Unit focuses on the areas of:</em>
                                        ...
                                        <li>Integration of UAVs into civilian airspace and activities which include precision agriculture, surveying for civilian and mapping application</li>
