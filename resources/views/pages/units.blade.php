                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">The E-Learning Research Unit, a member of the... <a href="{{ route('Elearning') }}" class="btn btn-primary btn-sm">Read More</a></p>
                        </div>
                    </div> 
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.4s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">Lorem ipsum dolor sit amet, consetetur am... <a href="#" class="btn btn-primary btn-sm disabled" >Read More</a></p>
                        </div>
                    </div> 
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.6s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">The Autonomous Vehicles, Autotronics,...  <a href="{{ route('autotronics') }}" class="btn btn-primary btn-sm">Read More</a></p>
                        </div>
                    </div> 
                </div>
                <div class="col-lg-3 col-sm-6">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.8s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">The web development unit is a member of ... <a href="{{ route('webDev') }}" class="btn btn-primary btn-sm">Read More</a></p>
                        </div>
                    </div> 
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.8s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">Specialists in the development, deployment and...<a href="{{ route('powerTech') }}" class="btn btn-primary btn-sm">Read More</a></p>
                        </div>
                    </div> 
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 text-center wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.8s">
                        ...
                        <div class="services_content">
                            ...
                            <p class="text-left" style="font-size: 14px;">Specialists in the development, deployment and...<a href="#" class="btn btn-primary btn-sm disabled" >Read More</a></p>
                        </div>
                    </div> 
                </div>
            </div> 
