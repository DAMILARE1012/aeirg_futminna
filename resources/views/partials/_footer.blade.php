<section id="footer" class="footer_area">
    <div class="footer_widget pt-80 pb-130">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6 order-md-1 order-lg-1">
                    <div class="footer_about mt-50">
                        <a href="#"><img src="{{ asset('assets/images/logo.svg') }}" alt="logo"></a>
                            <p>An industry-oriented, multi-disciplinary, research group that specialize in research and development, governmental contracting, and commercialization of innovations.</p>
                    </div> 
                </div>
            ...
            <p class="text-center mt-90">Designed and Developed by <a href="javascript:void(0)">EDU-DEE </a> &copy; Copyright 2021</p>
    </div> 
</section>
